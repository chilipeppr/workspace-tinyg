...
var pushToGithubSync = function() {
  ...
  stdout += proc.execSync('git add *; git commit -m "Made some changes to ChiliPeppr myWorkspace using Cloud9"; git push; git push origin master:gh-page;', { encoding: 'utf8' });
